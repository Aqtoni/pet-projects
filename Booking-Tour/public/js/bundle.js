parcelRequire = (function (e, r, t, n) {
...
})(
  {
    ...
    VjIL: [
      ...
      { 'base64-js': 'QAnv', ieee754: 'O1Qa', isarray: 'z6OH', buffer: 'VjIL' },
    ],
    q82J: [
      function (require, module, exports) {
    ...
    HXpE: [
      function (require, module, exports) {
        ...
        Object.defineProperty(exports, '__esModule', { value: !0 }),
          (exports.default = void 0);
        var e = x(require('./utils.js')),
          r = x(require('./helpers/bind.js')),
          t = x(require('./core/Axios.js')),
          a = x(require('./core/mergeConfig.js')),
          u = x(require('./defaults/index.js')),
          l = x(require('./helpers/formDataToJSON.js')),
          s = x(require('./cancel/CanceledError.js')),
          o = x(require('./cancel/CancelToken.js')),
          d = x(require('./cancel/isCancel.js')),
          i = require('./env/data.js'),
          n = x(require('./helpers/toFormData.js')),
          f = x(require('./core/AxiosError.js')),
          c = x(require('./helpers/spread.js')),
          p = x(require('./helpers/isAxiosError.js')),
          j = x(require('./core/AxiosHeaders.js')),
          q = x(require('./helpers/HttpStatusCode.js'));
        function x(e) {
          return e && e.__esModule ? e : { default: e };
        }
        function C(u) {
          const l = new t.default(u),
            s = (0, r.default)(t.default.prototype.request, l);
          return (
                  ...
                  return new r(function (o, c) {
                    !(function o(i, a, c, u) {
                      ...
                      if ('throw' !== s.type) {
                        var l = s.arg,
                          f = l.value;
                        return f && 'object' == n(f) && e.call(f, '__await')
        ...
        l &&
          l.addEventListener('submit', function (e) {
            ...
            var r = document.getElementById('name').value,
              ...
              o = document.getElementById('passwordConfirm').value;
            signup(r, t, s, o);
          }),
          d &&
